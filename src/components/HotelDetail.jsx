      ...
      <div className="max-w-5xl mx-auto p-4 mt-8">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10">
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div onClick={() => toggleFavorite(hotel.id)} className="absolute top-0 right-7 bg-white w-[40px] h-[40px] rounded-full flex items-center justify-center">
              <img className="w-[20px] h-[20px]" src={favorites.includes(hotel.id) ? liked : noLike} alt="" />
            </div>
          </div>
        </div>
